...
function setup() {
  ...
  box8 = new Box(770, 300, 50, 50)
  box9 = new Box(770, 300, 50, 50)
  boxes1 = new Box(770, 300, 50, 50)
  boxes2 = new Box(770, 300, 50, 50)
  boxes3 = new Box(770, 300, 50, 50)
  boxes4 = new Box(840, 300, 50, 50)
  boxes5 = new Box(840, 300, 50, 50)
  boxes6 = new Box(840, 300, 50, 50)
  boxes7 = new Box(840, 300, 50, 50)
  boxes8 = new Box(840, 300, 50, 50)
  boxes9 = new Box(840, 300, 50, 50)
  bo1 = new Box(910, 300, 50, 50)
  bo2 = new Box(910, 300, 50, 50)
  bo3 = new Box(910, 300, 50, 50)
  bo4 = new Box(910, 300, 50, 50)
  superMan= new Hero(370,60,270,70)
